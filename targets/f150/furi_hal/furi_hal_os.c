...
void furi_hal_os_init(void) {
    furi_hal_gpio_init_simple(&gpio_mcu_m40, GpioModeOutputOpenDrain);
    furi_hal_gpio_write(&gpio_mcu_m40, true);
    furi_hal_gpio_init_simple(&gpio_mcu_m41, GpioModeOutputOpenDrain);
    furi_hal_gpio_write(&gpio_mcu_m41, true);
    furi_hal_gpio_init_simple(&gpio_cpu_d3, GpioModeOutputOpenDrain);
    furi_hal_gpio_write(&gpio_cpu_d3, true);
    furi_hal_gpio_init_simple(&gpio_cpu_d2, GpioModeOutputOpenDrain);
    furi_hal_gpio_write(&gpio_cpu_d2, true);
    furi_hal_gpio_init_simple(&gpio_cpu_reset, GpioModeOutputOpenDrain);
    furi_hal_gpio_write(&gpio_cpu_reset, true);
    furi_hal_gpio_init_simple(&gpio_mcu_reset, GpioModeOutputOpenDrain);
    furi_hal_gpio_write(&gpio_mcu_reset, true);
